package br.com.authentication.exceptin.handle;

import br.com.authentication.exceptin.BusinessException;
import br.com.authentication.model.ExceptionModel;
...
public class CustomizeExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<Object> handleAllException(BusinessException ex, WebRequest request) throws Exception {
    	...
    	if(ex.getMessage().contains("could not execute statement; SQL [n/a]; constraint [IDX_DESC_TIPO_ITEM]")) 
    		retornoErro = "Registro duplicado!";
